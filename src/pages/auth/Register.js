  ...
  const handleFormSubmit = async (data) => {
    ...
    try {
      const response = await axios.post(
        'https://tiosone.com/users/api/users/signup/',
        {
          username: data.name,
          email: data.email,
      ...
      console.error("Kayıt sırasında hata:", err.response ? err.response.data : err.message);
      setError(err.response ? err.response.data.message : "Kayıt başarısız oldu. Lütfen tekrar deneyin.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <Block className="nk-block-middle nk-auth-body wide-xs">
      ...
      <PreviewCard className="card-bordered" bodyClass="card-inner-lg">
        ...
        <form className="is-alter" onSubmit={handleSubmit(handleFormSubmit)}>
          ...
          <div className="form-group">
            <label className="form-label" htmlFor="birth_date">Birth Date (Optional)</label>
            <div className="form-control-wrap">
              <input
                type="date"
                id="birth_date"
