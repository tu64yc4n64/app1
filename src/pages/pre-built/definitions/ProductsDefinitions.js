        ...
        <>
            ...
            <Content>
                <BlockHead size="sm">
                    <BlockBetween>
                        <BlockHeadContent>
                            <BlockTitle>Ürün Tanımlamaları</BlockTitle>
                            <div className="nk-block-des text-soft"><p>Ürünler uygulamanızdaki tanımlamaları ayarlayın.</p></div>
                        </BlockHeadContent>
                    </BlockBetween>
                </BlockHead>
...
export default ProductsDefinitions;
